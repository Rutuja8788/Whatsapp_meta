...
import com.example.simple_controller.dtos.EntryDTO;

import com.example.simple_controller.dtos.InteractiveMessageDTO;
import com.example.simple_controller.dtos.WebhookResponseDTO;
...
public class WebhookProcessingService {
    ...
    public WebhookProcessingService(WhatsappRequestService whatsappRequestService, ObjectMapper objectMapper, TemplateRepository messageTemplateRepository) {
    ...
    private void handleButtonReply(InteractiveMessageDTO interactiveMessageDTO) throws Exception {
        ...
        Optional<Template> optionalTemplateId = messageTemplateRepository.findTemplateByTemplateId(buttonId);
    ...
    private String determineTemplateId(EntryDTO entryDTO) {
        ...
        return "tmpl_001"; // Replace with actual logic
    }
}