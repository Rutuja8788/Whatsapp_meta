...
public class WhatsappRequestService {
    ...
    public WhatsappRequestService(RestTemplate restTemplate, TemplateRepository messageTemplateRepository) {
    ...
    public void sendMessage(String templateId) throws Exception {
        ...
        Template template = messageTemplateRepository.findByTemplateId(templateId)
                .orElseThrow(() -> new RuntimeException("Template not found"));

        String recipientNumber = "+918788530002";
        ...
        bodyNode.put("text", template.getBodyMessage());
